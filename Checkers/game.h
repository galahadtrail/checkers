...
private:
	...
	int who_can_move = 0;//цвет хода, 0 если ход белых, 1 если ход черных
	...
	Checkers_on_board_RCG checkers_on_board;//Расположение шашек на доске в режимах кроме международного
	Checkers_on_board_Inter checkers_on_board_inter;//Расположение шашек на доске в международном режиме
